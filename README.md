...
The current UI exposes only a role-scoped Meta/Orchestrator binding editor; it
...
delivery paths are metadata only: this slice does not read, watch, execute,
prompt, or write them. See the
