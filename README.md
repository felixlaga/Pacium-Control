...
`kill-session`; the external tmux server session may continue. PC-070 does not
yet launch new presets under tmux or automatically reattach them after the
local server restarts. Those keep-alive behaviors are PC-071.
