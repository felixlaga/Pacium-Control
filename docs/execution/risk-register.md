...
| R-21 | Native PTY dependency complicates install          |     Medium |        High | patched source build, pinned Xcode/Node, packaged arm64 canary, PC-076 clean-account gate                        | build/load failure on clean machine |
