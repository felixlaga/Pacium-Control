...
- Assessed implementation candidate:
  `ab108ab2b46c01a58ea3b40e77e800495a712b8c`
...
| --------------------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Source identity and hygiene             | pass    | `release:preflight` accepted clean commit `db7838abd937d8c4bc1bc001bcd02951cd7c34e2`, 559 tracked files, 20 required contracts, supported `darwin-arm64`, and Node 24.18.0. The final integrated head is checked again after documentation-only closure.                                                                                                                                                              |
| Preflight failure boundaries            | pass    | Seven unit cases reject foreign hosts/runtimes, dirty or forbidden source, unsafe archive paths, mismatched targets, duplicate paths, and unsupported release claims with scalar errors.                                                                                                                                                                                                                              |
...
| Ubuntu 24.04 x64 baseline               | pass    | PC-075 workflow run `30339736170`, job `90212373474`, passed frozen source-native install, 141 files/922 tests, build, soak, Linux package verification, and applicable Chromium in 3m18s at `07bba5b58254f1c58815cccb625b92c5df1e261a`. PC-076 requires one final exact-branch rerun before integration.                                                                                                             |
| Linux package baseline                  | pass    | The PC-075 runner reproduced a 584,044-byte archive, SHA-256 `b5da9fadf2db663123be8bc2a3d888d8a7d18520bb00bfbeb83b067e8fb5f7ca`, with 27 manifested files and passed the installed-package lifecycle.                                                                                                                                                                                                                 |
...
The Ubuntu baseline is not a substitute for the final exact-branch workflow.
The final workflow run and final integrated SHA belong in the integration
handoff so this assessment does not pretend a self-referential commit can name
itself.
