...
package_entry="$package_root/app/apps/local-server/dist/package-launcher.js"
...
PATH="$HOME/.local/bin:$HOME/.npm-global/bin:$HOME/.bun/bin:$HOME/.local/share/pnpm:/usr/local/bin:/usr/bin:/bin:$PATH"
export PATH
